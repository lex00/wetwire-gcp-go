...
// LaunchChat launches an interactive Kiro CLI chat session with the wetwire-gcp agent.
...
// Launch launches the Kiro CLI with the specified prompt.
func Launch(prompt string) error {
	return LaunchChat(AgentName, prompt)
}
