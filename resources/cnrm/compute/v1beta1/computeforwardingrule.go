...
// ComputeForwardingRuleSpec defines the desired state of ComputeForwardingRule.
type ComputeForwardingRuleSpec struct {
	...
	MetadataFilters []map[string]interface{} `json:"metadataFilters,omitempty" yaml:"metadataFilters,omitempty"`
	...
	ServiceDirectoryRegistrations []map[string]interface{} `json:"serviceDirectoryRegistrations,omitempty" yaml:"serviceDirectoryRegistrations,omitempty"`
...
// ComputeForwardingRuleStatus defines the observed state of ComputeForwardingRule.
