...
// NetworkServicesEdgeCacheOrigin represents a networkservices.cnrm.cloud.google.com NetworkServicesEdgeCacheOrigin resource.
...
// NetworkServicesEdgeCacheOriginSpec defines the desired state of NetworkServicesEdgeCacheOrigin.
type NetworkServicesEdgeCacheOriginSpec struct {
	// Enable AWS Signature Version 4 origin authentication.
	AwsV4Authentication map[string]interface{} `json:"awsV4Authentication,omitempty" yaml:"awsV4Authentication,omitempty"`
	...
	OriginOverrideAction map[string]interface{} `json:"originOverrideAction,omitempty" yaml:"originOverrideAction,omitempty"`
	// Follow redirects from this origin.
	OriginRedirect map[string]interface{} `json:"originRedirect,omitempty" yaml:"originRedirect,omitempty"`
...
// NetworkServicesEdgeCacheOriginStatus defines the observed state of NetworkServicesEdgeCacheOrigin.
