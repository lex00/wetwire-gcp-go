...
// AccessContextManagerServicePerimeter represents a accesscontextmanager.cnrm.cloud.google.com AccessContextManagerServicePerimeter resource.
...
type AccessContextManagerServicePerimeterSpec struct {
	...
	PerimeterType string `json:"perimeterType,omitempty" yaml:"perimeterType,omitempty"`
	...
	UseExplicitDryRunSpec bool `json:"useExplicitDryRunSpec,omitempty" yaml:"useExplicitDryRunSpec,omitempty"`
}

// AccessContextManagerServicePerimeterStatus defines the observed state of AccessContextManagerServicePerimeter.
